...
class ProductosController extends ControladorBase{
  ...
  public.usuarios";
    	...
    	$where    = "productos.id_usuarios_registra = usuarios.id_usuarios AND
  tipo_productos.id_tipo_productos = productos.id_tipo_productos";
  ...
  tipo_productos.id_tipo_productos = productos.id_tipo_productos AND id_productos = '$_id_productos' ";
					...
					$this->view("Productos",array(
							"resultProd" =>$resultProd, "resultEdit" =>$resultEdit
			...
			if (isset ($_POST["nombre_productos"]))
			{
				...
				if($_id_productos > 0){
					...
					if ($_FILES['imagen_productos']['tmp_name']!="")
					{
						...
						$colval = "id_tipo_productos= '$_id_tipo_productos', nombre_productos = '$_nombre_productos',  valor_productos = '$_valor_productos', imagen_productos='$imagen_productos'";
						$tabla = "productos";
					...
					else
					{
						...
						$colval = "id_tipo_productos= '$_id_tipo_productos', nombre_productos = '$_nombre_productos',  valor_productos = '$_valor_productos'";
						$tabla = "productos";
						$where = "id_productos = '$_id_productos'";
