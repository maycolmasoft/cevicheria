...
<html lang="es">
   ...
   <section class="content-header">
  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>INSERTAR<small>Ingredientes</small></h2>
                  ...
                  <div class="x_content">
						...
						<form action="<?php echo $helper->url("Ingredientes","InsertaIngredientes"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTADO<small>Ingredientes</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
