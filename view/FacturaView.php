...
<html lang="es">
        	   ...
        	   function load_pedidos_x_entregar(pagina){
                 ...
                 $("#load_pedidos_x_entregar_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Factura&action=search_x_entregar&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
           	              ...
           	              error: function(jqXHR,estado,error){
           	                $("#pedidos_x_entregar_registrados").html("Ocurrio un error al cargar la informacion de pedidos x facturar..."+estado+"    "+error);
           	              }
           	            });
        	   ...
        	   function load_pedidos_entregados(pagina){
                 ...
                 $("#load_pedidos_entregados_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Factura&action=search_entregados&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
           	              ...
           	              error: function(jqXHR,estado,error){
           	                $("#pedidos_entregados_registrados").html("Ocurrio un error al cargar la informacion de pedidos facturados..."+estado+"    "+error);
           	              }
           	            });
    ...
    <div class="container">
        <section class="content-header">
         ...
         <li class="active">Consulta Factura</li>
         </ol>
         </section>
  	...
  	<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Panel<small>Facturación</small></h2>
     ...
     <section class="content">
                   <div class='nav-tabs-custom'>
                    ...
                    <li id="nav-entregar" class="active"><a href="#entregar" data-toggle="tab">Pedidos por Facturar</a></li>
                     <li id="nav-entregados"><a href="#entregados" data-toggle="tab" >Pedidos Facturados</a></li>
                   </ul>
				...
				<form  action="<?php echo $helper->url("Factura","generar_reporte_x_entregar"); ?>" method="post" enctype="multipart/form-data" target="_blank"  class="col-lg-12 col-md-12 col-xs-12">
				...
				<div class="tab-pane" id="entregados">
               	...
               	<form  action="<?php echo $helper->url("Factura","generar_reporte_entregado"); ?>" method="post" enctype="multipart/form-data" target="_blank"  class="col-lg-12 col-md-12 col-xs-12">
                  <div class="row" style="margin-left:1px;">
									<div class="col-lg-2 col-xs-12 col-md-2">
                        		    <div class="form-group">
